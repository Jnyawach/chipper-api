...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('users/{user}/favorite', [FavoriteController::class, 'favoriteUser'])->name('favorites.user.store');
    Route::delete('users/{user}/favorite', [FavoriteController::class, 'unFavoriteUser'])->name('favorites.user.destroy');
